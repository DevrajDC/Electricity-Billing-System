<?php
  ...
  function displayBills() {
    ...
    while($row = $result->fetch_assoc()) {
      ...
      if($row['stage']=="Paid") echo "bg-green-100"; else if($row['stage']=="Unpaid") echo "bg-red-100"; else echo "bg-indigo-100";
      echo "'>".$row["stage"]."</span>
        </td>
        <td class='px-6 py-4 whitespace-nowrap'>
      ...
      echo "<form class='inline-flex'>
                    <form>
                        <script src=https://checkout.razorpay.com/v1/payment-button.js data-payment_button_id='pl_KExdYhPA2lZpYk' data-prefill.amount.cash='".$row["charges"]."'></script>
                    </form>
                    </script>
            </form>";
