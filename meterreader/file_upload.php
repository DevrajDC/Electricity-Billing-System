  ...
  <body>
    <main class="bg-gray-100 h-screen p-6">
      ...
      >
        ...
        <label
          for="dropzone-file"
          class="flex flex-col justify-center items-center w-full h-64 mb-6 bg-gray-50 rounded-lg border-4 border-gray-200 border-dashed cursor-pointer hover:bg-gray-100"
        >
