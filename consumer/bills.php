                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full <?php if ($row['stage'] == "Paid") echo "bg-green-100";
                                                                                                                                    else if ($row['stage'] == "Unpaid") echo "bg-red-100";
                                                                                                                                    else echo "bg-indigo-100" ?>"> <?php echo $row["stage"] ?> </span>
                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="text-sm text-gray-900">
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-right">
                                                        ...
                                                        <?php } else { ?>
                                                            <form class="inline-flex">
                                                                <a href="javascript:void(0)" class="no-underline inline-flex items-center ml-3 px-2.5 py-1.5 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-blue-600 hover:bg-blue-700 hover:no-underline focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 mr-2" data-amount="<?php echo $row['charges']; ?>"> <svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 mr-2">
                                                                        <path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zM9 7.5A.75.75 0 009 9h1.5c.98 0 1.813.626 2.122 1.5H9A.75.75 0 009 12h3.622a2.251 2.251 0 01-2.122 1.5H9a.75.75 0 00-.53 1.28l3 3a.75.75 0 101.06-1.06L10.8 14.988A3.752 3.752 0 0014.175 12H15a.75.75 0 000-1.5h-.825A3.733 3.733 0 0013.5 9H15a.75.75 0 000-1.5H9z" clip-rule="evenodd" />
                                                                    </svg>
                                                                    PayBill
                                                                </a>
...
<script>
    $('body').on('click', '.pay_now', function(e) {
        ...
        var options = {
            ...
            "name": "EBS",
            "description": "Payment",
            "callback_url": "http://localhost/Electricity-Billing-System/consumer/payment-process.php",
            "handler": function(response) {
                $.ajax({
                    url: 'http://localhost/Electricity-Billing-System/consumer/payment-process.php',
                    type: 'post',
                    dataType: 'json',
                    data: {
                    ...
                    success: function(msg) {
                        window.location.href = 'http://localhost/Electricity-Billing-System/consumer/success.php';
                    }
                });
            },
