            ...
            <div class="max-w-md px-6 mx-auto lg:mt-20 sm:mt-2">
                ...
                <div class="">
                    ...
                    <div id="l1" class="mt-8">
                        <form id="f1" action="#" method="POST" class="space-y-6 pr">
                            <div style="opacity:0; animation-name:changeform; animation-delay:0s; animation-duration: 0.5s;animation-timing-function:ease-in;animation-fill-mode: forwards;">
                                ...
                                <div class="mt-1">
                                    <input id="email2" name="email" type="email" autocomplete="email" required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </div>
                            </div>
                            ...
                            <div class="space-y-1" style="opacity:0; animation-name:changeform; animation-delay:0.03s;  animation-duration: 0.5; animation-timing-function:ease-in;animation-fill-mode: forwards;">
                                ...
                                <div class="mt-1">
                                    <input id="password2" name="password" type="password" autocomplete="current-password" required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                <small></small>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-between" style="opacity:0; animation-name:changeform; animation-delay:0.06s;  animation-duration: 0.5s; animation-timing-function:ease-in;animation-fill-mode: forwards;">
                                ...
                                <div class="text-sm" style="opacity:0; animation-name:changeform; animation-delay:0.09s; animation-duration: 0.5s; animation-timing-function:ease-in;animation-fill-mode:forwards;">
                                    <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500"> Forgot your
                                        password? </a>
                                </div>
                            </div>

                            <div style="opacity:0;animation-name:changeform; animation-delay:0.12s; animation-duration: 0.5s; animation-timing-function:ease-in;animation-fill-mode: forwards;">
                    ...
                    <form id="l2" style="display:none;" action="#" method="POST" class="space-y-4 pr mt-8">
                        <div style="opacity:0; animation-name:changeform; animation-delay:0s; animation-duration: 0.5s;animation-timing-function:ease-in;animation-fill-mode: forwards;">
                            ...
                            <div class="mt-1">
                                <input id="email1" name="email" type="email" autocomplete="email" required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                <small></small>
                            </div>
                        </div>
                        <div style=" opacity:0; animation-name:changeform; animation-delay:0.03s; animation-duration: 0.5s; animation-timing-function:ease-in;animation-fill-mode: forwards;">
                            ...
                            <div class="mt-1">
                                <input id="name" name="email" type="text" autocomplete="email" required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                <small></small>
                            </div>
                        </div>
                        ...
                        <div style="opacity:0; animation-name:changeform; animation-delay:0.06s; animation-duration: 0.5s; animation-timing-function:ease-in;animation-fill-mode: forwards;">
                            ...
                            <div class="mt-1">
                                <input id="phone" name="email" type="number" autocomplete="email" required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                <small></small>
                            </div>
                        </div>
                        ...
                        <div class="space-y-1" style="opacity:0; animation-name:changeform; animation-delay:0.12s; animation-duration: 0.5s; animation-timing-function:ease-in;animation-fill-mode: forwards;">
                            <label for="password" class="block text-sm font-medium text-gray-700"> Password </label>
                            <div class="mt-1">
                                <input id="password1" name="password" type="password" autocomplete="current-password" required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            <small></small>
                            </div>
                        </div>
