...
<body>
    <div class="bg-white dark:bg-gray-900">
        <div class="flex justify-center h-screen">
            <div id="img" class="hidden bg-cover lg:block lg:w-2/3"
                style="transition: all 0.5s; background-image: url(https://images.unsplash.com/photo-1616763355603-9755a640a287?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80)">
                ...
                <div class="flex-1 mt-6">
                    ...
                    <div class="hidden sm:block flex">
                        <nav >
                            ...
                            <a id="nm1" href="#"
                                class="menu3 bg-indigo-100 border-indigo-500 text-indigo-600 whitespace-nowrap pt-2 pb-2 px-12 border-b-2 font-medium text-sm"
                                onclick="navcolor('nm1','nm2','','menu3 bg-indigo-100 border-indigo-500 text-indigo-600 whitespace-nowrap pt-2 pb-2 px-12 border-b-2 font-medium text-sm', 'menu2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap pt-2 pb-2 px-12 border-b-2 font-medium text-sm')
                                ,changeslide('l1','l2','')">
                                Login </a>

                            <a  id="nm2" href="#"
                                class=" menu2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap pt-2 pb-2 px-12 border-b-2 font-medium text-sm"
                                onclick="navcolor('nm2','nm1','','menu3 bg-indigo-100 border-indigo-500 text-indigo-600 whitespace-nowrap pt-2 pb-2 px-12 border-b-2 font-medium text-sm', 'menu2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap pt-2 pb-2 px-12 border-b-2 font-medium text-sm'),changeslide('l2','l1','')">
                                Register </a>
                        </nav>
                    </div>
                    <!-- sign in -->
