                ...
                <div class="divide-y divide-gray-200">
                  ...
                  <div class="mt-2 pt-6 grid grid-cols-1 gap-y-6 gap-x-4">
                    <div class="sm:col-span-3">
                      ...
                      <div class="mt-1">
                        <textarea rows="3" name="meter-no" id="meter-no" class="w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"></textarea>
                      </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                      ...
                      <div class="mt-1">
                        <select class="w-full px-2 py-1.5 text-base font-normal text-gray-700 bg-white border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none">
                          <option value="pending">Industrial</option>
                          <option value="resolved">Agriculture</option>
                          <option value="resolved">Domestic</option>
                          <option value="resolved">Commercial</option>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                      ...
                      <div class="mt-1">
                        <select class="w-full px-2 py-1.5 text-base font-normal text-gray-700 bg-white border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none">
                          <option value="pending">Phase 1</option>
                          <option value="resolved">Phase 2</option>
                          <option value="resolved">Phase 3</option>
                        </select>
                      </div>
                    </div>
                  </div>
