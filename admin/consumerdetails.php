          ...
          <div class="py-2 bg-white align-middle inline-block min-w-full sm:px-6 lg:px-8 shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            <div class="relative pt-5 border-b border-gray-200 sm:pb-0">
              <div class="md:flex md:items-center md:justify-between">
                ...
                <button type="button" onclick="toggleModal('Delete-modal')" class="inline-flex items-center px-2.5 py-1.5 border border-transparent rounded shadow-sm text-xs font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">Disable</button>
              ...
              <div class="mt-4">
                ...
                <div class="hidden sm:block">
                  <nav class="-mb-px flex">
                    ...
                    <a id="m1" href="#details" class="menu3 bg-indigo-100 border-indigo-500 text-indigo-600 whitespace-nowrap pt-2 pb-2 px-4 border-b-2 font-medium text-sm" onclick="changeslide('p1','p2','p3'),navcolor('m1','m2','m3','menu3 bg-indigo-100 border-indigo-500 text-indigo-600 whitespace-nowrap pt-2 pb-2 px-4 border-b-2 font-medium text-sm','menu2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap pt-2 pb-2 px-4 border-b-2 font-medium text-sm'),changename('Applicant Information','b1','b2','b3')">
                      Details </a>
                    ...
                    <a id="m3" href="#bill" class="menu2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap pt-2 pb-2 px-4 border-b-2 font-medium text-sm" aria-current="page" onclick="changeslide('p3','p1','p2',),navcolor('m3','m2','m1','menu3 bg-indigo-100 border-indigo-500 text-indigo-600 whitespace-nowrap pt-2 pb-2 px-4 border-b-2 font-medium text-sm',' menu2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap pt-2 pb-2 px-4 border-b-2 font-medium text-sm'),changename('Bill Information','b2','b1','b3')">
                      Bill </a>
                  </nav>
                </div>
              </div>
            ...
            <div>
              ...
              <!-- <div class="flex w-full- items-center">
                <div class="w-full">
                  ...
                  <button id="b1" type="button" onclick="toggleModal('Delete-modal')" class="inline-flex items-center px-2.5 py-1.5 border border-transparent rounded shadow-sm text-xs font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">update</button>
                  <button style="display: none;" id='b2' type="button" onclick="toggleModal('Delete-modal')" class="inline-flex items-center px-2.5 py-1.5 border border-transparent rounded shadow-sm text-xs font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">update</button>
                  <button style="display: none;" id='b3' type="button" onclick="toggleModal('Delete-modal')" class="inline-flex items-center px-2.5 py-1.5 border border-transparent rounded shadow-sm text-xs font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">update</button>
                </div>
              </div>
            </div> -->
              <!-- Details Tab -->
              <div id="p1" class="mt-5 border-b border-gray-200">
                <div class="w-full flex justify-between">
                  <h3 class="text-lg leading-6 font-medium text-gray-900" id="hh1">Consumer Information</h3>
                  <button id="b1" type="button" class="inline-flex items-center px-2.5 py-1.5 border border-transparent rounded shadow-sm text-xs font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">update</button>
                </div>
                          ...
                          <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                              <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"> <button type="button" onclick="toggleModal('add-meter-modal')" class="h-fit px-2.5 py-1.5  text-xs font-medium rounded  text-indigo-600  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Update
                                  </button>
                                </td>
                              </tr>
                              <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"> <button type="button" disabled onclick="toggleModal('add-meter-modal')" class="h-fit px-2.5 py-1.5 cursor-not-allowed text-xs font-medium rounded  text-gray-600  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Update
                                  </button>
                                </td>
                              </tr>
        ...
        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
          ...
          <div class="mt-2">
            <p class="text-sm text-gray-500">
              Are you sure you want to Disable this Account? This action cannot
              be undone.
            </p>
          </div>
        </div>
