...
function populateForm(data) {
  ...
  document.getElementById("consumer-id").value = data;
}
...
function navcolor(j1, j2, j3) {
  var t =
    "menu3 bg-indigo-100 border-indigo-500 text-indigo-600 whitespace-nowrap pt-2 pb-2 px-4 border-b-2 font-medium text-sm";
  var j =
    "menu2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap pt-2 pb-2 px-4 border-b-2 font-medium text-sm";
